...
const Experties = () => {
  return (
    <div className='px-5 pt-[95px] pb-8 mob:py-10'>
      <div
        className='w-full max-w-[1250px] mx-auto flex flex-wrap gap-[48px] mob:gap-[40px] tab:justify-center justify-between '
        data-aos='zoom-out'
        data-aos-duration='900'
        data-aos-easing='ease-in-sine'>
        {/* left */}
        <div className='w-full max-w-[577px]'>
          <img className='w-full' src={experties.src} alt='experties' />
        </div>
            ...
            {expertiseData.map((item) => (
              <div
                ...
                className={`px-[10px] py-5 w-full max-w-[189px] min-h-[184px] rounded-[12px] transition-transform duration-300 hover:scale-[1.1] ${
                  [2, 4, 6].includes(item.id)
                    ? "shadow-[5px_5px_7.2px_0px_rgba(156,163,175,0.4)]"
                    : ""
                }`}>
                <img
                  className='mx-auto'
